local Configs_HUB = {
	Cor_Hub = Color3.fromRGB(100, 7, 0),
...
function MakeNotifi(Configs)
	...
	local text = Configs.Text or "By : Edit SCript"
...
function MakeWindow(Configs)
	local title = Configs.Hub.Title or "7XP HUB"
	local Anim_Title = Configs.Hub.Animation or "by : Edit SCript "
